...
export default function Page() {
    ...
    return (
        <div>
            <PageHeadingTitle title= {t("bookmarks")} subtitle= {t("view_bookmarks_cases_and_law_bylaw")} />
                ...
                <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-3">
                    <div className="w-full md:w-auto flex flex-col md:flex-row items-center justify-center gap-3">
                        <button
                            ...
                            className={`${activeBtn === "cases" ? "bg-[#135576] text-white" : "bg-[#135576]/10 text-[#135576]"} w-full md:w-auto  px-5 py-2 rounded-full hover:cursor-pointer transition-all duration-300`}>{t("cases")}</button>
                        <button
                            onClick={() => setActiveBtn("law")}
                            className={`${activeBtn === "law" ? "bg-[#135576] text-white" : "bg-[#135576]/10 text-[#135576]"} w-full md:w-auto  px-5 py-2 rounded-full hover:cursor-pointer transition-all duration-300`}>{t("laws_and_bylaws")}</button>
                    </div>
