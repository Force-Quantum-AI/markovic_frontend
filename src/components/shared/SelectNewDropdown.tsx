...
export function SelectField({ label, type, categoryId, value, onChange }: SelectFieldProps) {
  ...
  return (
    <select
      ...
      className="w-full px-5 py-3.5 border border-gray-200 rounded-full text-sm text-gray-900 bg-white outline-none focus:ring-2 focus:ring-[#135576]/20 focus:border-[#135576] appearance-none cursor-pointer transition-all shadow-sm"
    >
