...
export default function Language() {
  const {
    data: languageAndTimeSettingData,
    isLoading: isLanguageAndTimeSettingLoading,
  } = useGetLanguageAndTimeSettingQuery({});
  const [updatelanguageAndTimeSetting] =
    useUpdateLanguageAndTimeSettingMutation();
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div className="flex items-center gap-6">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-[#364153] text-base font-medium">
                  12-hour
                </span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
