...
import { useGetLeftSideCaseDetailsQuery, useGetLeftSideClientCaseDetailsQuery, useLazyGetRightSideCaseDetailsQuery } from "@/store/features/case/case.api";
...
export default function ClientCaseDetailsPage({clientCaseId}: {clientCaseId: string}) {
  ...
  // RTK Queries
  const { data: caseDataOfLeftSide, isLoading: isLoadingCaseDataOfLeftSide } = useGetLeftSideClientCaseDetailsQuery(clientCaseId);
  ...
  const handleCaseSelect = (id: string) => {
    ...
    getRightSideCaseDetails({ leftCaseId: clientCaseId, rightCaseId: id });
  };
