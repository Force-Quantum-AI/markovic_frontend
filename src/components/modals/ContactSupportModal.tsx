...
export default function ContactSupportModal({ isOpen, onClose }: ContactSupportModalProps) {
  ...
  const [fullName, setFullName] = useState("Markovic Aleksa");
  const [email, setEmail] = useState("markovic@email.com");
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6 overflow-y-auto bg-[#F8FAFC]">
          ...
          <div className="flex flex-col items-center justify-center pt-2">
            <button
              ...
              className={`w-full max-w-xs py-3.5 px-6 rounded-full font-bold text-sm tracking-wide shadow-md transition-all duration-150 ${
                isSuccess
